...
// // import Grid from '@mui/material/Grid'; // Separate Grid import
...
// import { Container, Typography, Paper, Button, Box, Chip } from '@mui/material';
// import { Link } from 'react-router-dom';
...
//             </Typography>
//             <Typography variant="body1">
//               {loading ? "Loading..." : `${deployments.length} deployments total`}
//             </Typography>
//           </Paper>
//         </GridItem>
...
//                         {deployment.parameters.name} ({deployment.resource_type})
//                       </Typography>
